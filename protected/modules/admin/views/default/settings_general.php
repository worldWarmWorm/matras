...
<div class="row">
    <?php echo $form->label($model,'workinghours'); ?>
    <?php echo $form->textField($model,'workinghours', array('class'=>'form-control'))?>
    <?php echo $form->error($model,'workinghours'); ?>
</div>

<div class="row">
    <?php echo $form->label($model,'vk_link'); ?>
    <?php echo $form->textField($model,'vk_link', array('class'=>'form-control'))?>
