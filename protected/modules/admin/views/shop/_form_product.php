...
?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <?= $form->labelEx($model, $model->complectationsBehavior->attribute); ?>
        </div>
        <div class="panel-body">
        <? $this->widget('\common\widgets\form\CheckboxListField', A::m(compact('form', 'model'), [
            'attribute'=>$model->complectationsBehavior->attribute,
            'data'=>\ProductComplectations::model()->listData('title'),
            'hideLabel'=>true,
            'htmlOptions'=>[
                'container'=>'div', 
                'labelOptions'=>['class'=>'inline', 'style'=>'font-weight:normal'],
