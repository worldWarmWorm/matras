...
abstract class WebModule extends \CWebModule
{
	 ...
	 */
	public static function t($path='main', $message=null, $category=null)
	{
	    $called=get_called_class();
	    $module=$called::i();
	    
	    if($category === null) {
	        $category=Y::param($module->getBaseAlias() . '.translate.' . $path, get_called_class() . '.' . $path);
	    }
	    
	    if($message === null) {
	        return Y::ct($category);
	    }
