    ...
    public function run()
    {
        ...
        if($this->url && $this->container) {
            if($this->pageCount > 1) {
                ...
                echo \CHtml::link($this->label, '#', $this->htmlOptions);
